  ...
  return (
    <main className='h-[2800px]'>
      ...
      <section className='relative w-[100%] h-[200px] top-[592px]'>
        ...
        <div className=' w-[100%] h-[420px] max-md:top-[50px] max-md:overflow-x-scroll absolute top-[120px] max-md:w-[430px] flex justify-center max-md:block'>
          <div className='mr-5 relative mydiv max-md:mr-0 w-fit max-md:left-[50%] max-md:translate-x-[-50%] max-md:mb-32 hover:scale-105 duration-[.4s] hover:mr-[30px]'>
          ...
          <div className='mr-5 w-fit relative hover:scale-105 max-md:left-[50%] max-md:translate-x-[-50%] hover:ml-3 max-md:mr-0 max-md:mb-32 hover:mr-[30px] duration-[.4s]'>
          ...
          <div className='relative w-fit duration-[.4s] max-md:left-[50%] max-md:translate-x-[-50%] hover:scale-105 hover:ml-3'>
      ...
      <section className='relative w-[100%] h-[700px] top-[980px]'>
        <h1 className='font-[500] max-md:text-[30px] max-md:font-[400] text-center max-md:top-[-10px] text-white absolute left-[50%] uppercase translate-x-[-50%] text-[45px] top-[15px]'>timeline evolution</h1>
        <Image src={timeline} alt='' className='absolute max-md:block hidden scale-110 top-[160px] left-[50%] translate-x-[-50%]'></Image>
        <div className='absolute w-[100%] h-[3px] bg-white/100 left-0 top-[430px] max-md:hidden'></div>
        <div className='flex w-fit relative left-[50%] translate-x-[-50%] top-[470px] max-md:hidden'>
          <div className='years'>
      ...
      <section className='relative w-[100%] max-md:top-[1200px] top-[918px]'>
        <h1 className='font-[500] text-white max-md:text-[30px] text-center absolute left-[50%] uppercase translate-x-[-50%] text-[45px] top-[15px]'>contact now!</h1>
        <Image src={contactimage} alt='' className='relative max-md:block hidden w-[100%] top-[170px]'></Image>
        <Image src={contactImage} alt='' className='relative max-md:hidden w-[100%] top-[150px]'></Image>
        <div className='w-[1280px] max-md:w-[410px] h-[514px] max-md:rounded-[30px] max-md:h-[410px] absolute max-md:top-[170px] top-[200px] bg-white/510 left-[50%] rounded-[80px] translate-x-[-50%] max-lg:w-[300px] backdrop-blur-xl myshadow'>
          <h3 className='uppercase font-thin text-[21px] absolute text-white pt-[60px] left-[120px] max-md:text-[16px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:pt-[20px]'>first name</h3>
          <input type="text" className='absolute left-[120px] duration-300 pl-[10px] shadow-xl focus:outline-none focus:border-dotted focus:border-[2px] text-white w-[243px] h-[48px] bg-white/10 rounded-[2px] top-[110px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:top-[60px]' />
          <div className='absolute left-[120px] pl-[10px] w-[243px] h-[5px] bg-[#002147] rounded-tr-none rounded-tl-none rounded-[2px] top-[156px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:top-[106px]'></div>
          <h3 className='uppercase font-thin text-[21px] absolute text-white pt-[60px] left-[420px] max-md:text-[16px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:pt-[120px]'>last name</h3>
          <input type="text" className='absolute duration-300 left-[420px] shadow-xl pl-[10px] focus:outline-none focus:border-dotted focus:border-[2px] text-white w-[243px] h-[48px] bg-white/10 rounded-[2px] top-[110px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:top-[150px]' />
          <div className='absolute left-[420px] pl-[10px] w-[243px] h-[5px] bg-[#002147] rounded-tr-none rounded-tl-none rounded-[2px] top-[156px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:top-[193px]'></div>
          <h3 className='uppercase font-thin text-[21px]  absolute text-white pt-[60px] left-[720px] max-md:text-[16px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:pt-[210px]'>phone name</h3>
          <input type="text" className='absolute duration-300 left-[720px] pl-[10px] focus:outline-none focus:border-dotted focus:border-[2px] text-white w-[283px] h-[48px] bg-white/20 shadow-xl rounded-[2px] top-[110px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:top-[240px]' />
          <div className='absolute left-[720px] pl-[10px] w-[283px] h-[5px] bg-[#002147] rounded-tr-none rounded-tl-none rounded-[2px] top-[156px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:top-[283px]'></div>
          <h3 className='uppercase font-thin text-[21px] absolute text-white pt-[60px] left-[120px] top-[135px] max-md:text-[16px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:pt-[170px]'>message</h3>
          <textarea className='absolute p-[20px] left-[120px] focus:outline-none focus:border-dotted focus:border-[2px] duration-300 text-white w-[703px] h-[248px] max-md:w-[300px] max-md:h-[60px] bg-white/20 shadow-xl rounded-[2px] top-[240px] max-md:left-[50%] max-md:translate-x-[-50%] max-md:top-[330px]' />
          <div className='absolute left-[120px] w-[703px] h-[5px] max-md:w-[300px] max-md:top-[385px] bg-[#002147] rounded-tr-none rounded-tl-none rounded-[2px] top-[483px] max-md:left-[50%] max-md:translate-x-[-50%]'></div>
        </div>
      </section>
